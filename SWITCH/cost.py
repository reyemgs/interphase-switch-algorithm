...
import numpy as np
    #My_Cost
def costfunction(vec_x, pbest_vector,                             #Sumthd и calculation fitness   
                 pbest_value, numof_value,                    #функции вызываемые как аргументы
                 convergence_curve, all_costs,
                 sumthd, calculationfitness): 
